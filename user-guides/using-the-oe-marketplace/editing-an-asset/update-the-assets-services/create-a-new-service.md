...
<mark style="color:$info;background-color:$info;">For a description of each of these attributes, please review step 3 of the</mark> [<mark style="color:$info;background-color:$info;">Publishing an asset</mark>](../../publishing-an-asset/) <mark style="color:$info;background-color:$info;">page.</mark>&#x20;
