...
* [_Edit Asset_](update-the-assets-attributes-and-state.md) (preselected), to update the asset's attributes and state
* [_Edit Services_](update-the-assets-services/) to update the attributes or the state of an existing service, or to add a new service to the asset
