...
| --------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `url`     | Static URL. Optional HTTP method, headers, and userdata. | <pre class="language-json"><code class="lang-json">{
  "type": "url",
...
| `arweave` | Arweave transaction ID.                                  | <pre class="language-json"><code class="lang-json">{
  "type": "url",
  "url": "https://url.com/file1.csv",
  "method": "GET",
  "headers": [
...
| Type       | Description                                     | Example                                                                                               |
| ---------- | ----------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `ipfs`     | IPFS file hash.                                 | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX"
}</code></pre> |
| `filecoin` | Filecoin storage                                | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX"
}</code></pre> |
| `storj`    | Storj                                           | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX"
}</code></pre> |
| `sql`      | Sql connection, dataset is generated by a query | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX"
}</code></pre> |
| `graph`      | Subgraph data feed.                           | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX"
}</code></pre> |
| `chainlink   | Chainlink data feed.                          | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX"
}</code></pre> |
