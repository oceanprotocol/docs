...
| `arweave` | Arweave transaction ID. Optional headers and userdata.   | <pre class="language-json"><code class="lang-json">{
  "type": "arweave",
...
| Type        | Description                                     | Example                                                                                                                                                                                                              |
| ----------- | ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ipfs`      | IPFS file hash. Optional headers and userdata.  | <pre class="language-json"><code class="lang-json">{
  "type": "ipfs",
  "hash": "XXX",
  "headers": [
    {"Authorization": "Bearer 123"},
...
| `graph`     | Subgraph data feed.                             |                                                                                                                                                                                                                      |
| `chainlink` | Chainlink data feed.                            |                                                                                                                                                                                                                      |
| `storj`     | Storj                                           |                                                                                                                                                                                                                      |
