...
Static URL with optional HTTP method, headers, and userdata.
...
IPFS file hash. Optional headers and userdata.
...
Sql connection, dataset is generated by a query.

**Multiple files and storage objects**
