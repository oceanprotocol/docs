...
To get information about the files after encryption, the `/fileinfo` endpoint of the [_Provider_](https://github.com/OceanProtocolEnterprise/docs/blob/OE-structure/developers/old-infrastructure/provider/README.md) returns based on a passed DID an array of file metadata (based on the file type):
