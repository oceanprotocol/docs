...
An _asset_ has a DID and DDO. The DDO should include metadata about the asset, and define access in at least one [service](/broken/pages/dd4e368QBuvVe0L8VV4B#services). Only _owners_ or _delegated users_ can modify the DDO.
...
* [**\_metaDataState**](/broken/pages/dd4e368QBuvVe0L8VV4B#state) - Each asset has a state, which is held by the NFT contract. One of the following: active (0), end-of-life (1), deprecated (2), revoked (3), ordering temporarily disabled (4), and asset unlisted (5).
...
* **data -** The [DDO](/broken/pages/dd4e368QBuvVe0L8VV4B) of the asset. You create the DDO as a JSON, send it to the [Provider](../old-infrastructure/provider/) that encrypts it, and then you set it up at the contract level.
