...
For other bridges and networks, see the [Networks page](networks.md).
...
<img src="../.gitbook/assets/binance-receive.png" alt="Binance deposit" data-size="original">
{% endhint %}
...
![Ocean on Polygon](../.gitbook/assets/polygon-ocean.png)
...
Alternatively, you can manually configure the network on Metamask by using the following parameters. To learn how to set up a custom network in Metamask using these values, you can refer to this [guide](https://github.com/oceanprotocol/docs/blob/main/discover/wallets/metamask-setup.md#set-up-custom-network).
...
_Next:_ [_FAQ_](faq.md)

_Back:_ [_Networks_](networks.md)
